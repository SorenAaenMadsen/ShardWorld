...
public enum Recipe {
    ...
    PRIMITIVE_COPPER_SMELTING(10, "Primitive copper smelting", "Copper", "1", "The ore is crushed using stone tools, and mixed with charcoal in a small furnace. The furnace is a one-use structure, built as a pit furnace, dug into the ground or a small clay furnace. Bellows or blowpipes must be used to reach temperatures of around 1,100 degree Celsius required to melt the copper.  After hours of heating, small droplets of molten copper, known as copper prills, forms and settles at the bottom of the furnace. When the furnace is cooled, these copper prills can be collected.", "Copper Ore", "10", "Charcoal", "6", "Stone tools", "3", "0", "72", "", "", "", "Wood tools", "10", "Stone tools", "4", "Null", "0"),
    ...
    SHAFT_FURNACE_IRON_CASTING_AND_SMITHING_OF_IRON_TOOLS(21, "Shaft Furnace Iron Casting and Smithing of Iron Tools", "Iron tools", "150", "Using a Shaft Furnace, the temperature of the iron can be brought to 1,300-1,500 degree Celsius, high enough to produce molten iron, especially with effective bellows.  This allow production of cast iron, by pouring molten iron into molds for larger-scale production.", "Wrought Iron", "160", "Charcoal", "240", "Null", "0", "", "3200", "", "", "", "Iron tools", "40", "Stone tools", "80", "Null", "0"),
