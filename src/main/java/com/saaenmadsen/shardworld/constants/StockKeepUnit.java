...
public enum StockKeepUnit {
    ...
    BRASS_BAR (5, "Brass, bar", SkuUsageClassification.METAL, "", "", 33),
    ...
    BRASS_PLATE (9, "Brass, plate", SkuUsageClassification.METAL, "", "", 33),
    BRASS_WIRE (10, "Brass, wire", SkuUsageClassification.METAL, "", "", 33),
    ...
    GOLD_BAR (21, "Gold, bar", SkuUsageClassification.METAL, "", "", 33),
    ...
    SCRAP_BRONZE_METAL (42, "Scrap Bronze metal", SkuUsageClassification.METAL, "kg", "", 33),
    SCRAP_COPPER_METAL (43, "Scrap copper metal", SkuUsageClassification.METAL, "kg", "", 33),
    SOYA (44, "Soya", SkuUsageClassification.FOOD, "", "", 33),
    SCRAP_IRON_METAL (45, "Scrap iron metal", SkuUsageClassification.METAL, "kg", "", 33),
    SCRAP_STEEL_METAL (46, "Scrap Steel metal", SkuUsageClassification.METAL, "kg", "", 33),
    SILVER_ORE (47, "Silver Ore", SkuUsageClassification.ORE, "", "", 88),
    SILVER_BAR (48, "Silver, bar", SkuUsageClassification.METAL, "", "", 33),
    ...
    STAINLESS_STEEL (50, "Stainless Steel", SkuUsageClassification.METAL, "kg", "Stainless Steel is alloyed using chromium.", 33),
    ...
    TIN (55, "Tin", SkuUsageClassification.METAL, "", "", 33),
