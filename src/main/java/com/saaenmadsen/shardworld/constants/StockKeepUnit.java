...
public enum StockKeepUnit {
    TIMBER_RAW_KG (0, "Timber, raw, kg", "Raw material", "kg", "Raw timber, newly felled and fresh. Sold pr. Kg", 3),
    FIREWOOD_KG (1, "Firewood, kg", "Fuel", "kg", "Firewood", 3),
    TIMBER_CURED_KG (2, "Timber, cured, kg", "Raw material", "kg", "Timber, cured, ready for the sawworks or chopping into firewood. Sold pr. Kg", 205),
    WOOD_KG (3, "Wood, kg", "Raw material", "kg", "Wood, either in planks, blocks or beams. Sold pr. Kg.", 22),
    RAW_PELT (4, "Raw Pelt", "Raw material", "m2", "Raw pelts. Sold in m2", 80),
    BRASS_BAR (5, "Brass, bar", "Raw material", "", "", 33),
    PAIR_OF_SHUES_WOODEN (6, "Pair of Shues, Wooden", "Shue", "Count", "Shue made entirely of wood. ", 312),
    ...
    CHARCOAL (13, "Charcoal", "Fuel", "", "", 22),
    COAL_MINED (14, "Coal, Mined", "Fuel", "", "", 176),
    COPPER (15, "Copper", "Raw material", "", "", 6019),
    CHICKEN (16, "Chicken", "Animal", "", "", 33),
    COPPER_ORE (17, "Copper Ore", "Ore", "", "", 198),
    COPPER_TOOLS (18, "Copper tools", "Tools", "kg", "", 7173),
    ...
    HARD_STEEL (26, "Hard Steel", "", "kg", "This technique involves melting wrought iron with carbon in small crucibles, creating steel with unique properties that allowes for strong, flexible, and sharp-edged weapons. ", 2318),
    IRON_ORE (27, "Iron Ore", "Ore", "kg", "", 132),
    IRON_TOOLS (28, "Iron tools", "Tools", "kg", "", 2318),
    LAPIS_LAZULI (29, "Lapis Lazuli", "Precious Stone", "", "", 2318),
    MILD_STEEL (30, "Mild Steel", "Raw material", "", "Mild steel is a type of carbon steel with a low amount of carbon. It is also known as low carbon steel. ", 2318),
    ...
    SILVER_ORE (47, "Silver Ore", "Ore", "", "", 88),
    ...
    WROUGHT_IRON (52, "Wrought Iron", "Raw material", "kg", "Wrought Iron is relatively soft but malleable. It contains traces of slag, making it less pure than modern iron but still highly functional for making a variety of tools and weapons.", 1743),
    STEEL_TOOLS (53, "Steel tools", "Tools", "kg", "", 33),
    STONE_TOOLS (54, "Stone tools", "Tools", "kg", "", 880),
    TIN (55, "Tin", "Raw material", "", "", 33),
    TIN_ORE (56, "Tin Ore", "Ore", "", "", 264),
    TOPAZ (57, "Topaz", "Precious Stone", "", "", 33),
    WOOD_TOOLS (58, "Wood tools", "Tools", "kg", "", 378),
    ;
