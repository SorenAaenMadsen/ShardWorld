...
public enum StockKeepUnit {
    ...
    BRASS_BAR (5, "Brass, bar", SkuUsageClassification.RAW_MATERIAL, "", "", 33),
    ...
    BRASS_PLATE (9, "Brass, plate", SkuUsageClassification.RAW_MATERIAL, "", "", 33),
    BRASS_WIRE (10, "Brass, wire", SkuUsageClassification.RAW_MATERIAL, "", "", 33),
    APPLES (11, "Apples", SkuUsageClassification.FOOD, "", "", 33),
    BRONZE_TOOLS (12, "Bronze tools", SkuUsageClassification.TOOLS, "kg", "", 33),
    CHARCOAL (13, "Charcoal", SkuUsageClassification.FUEL, "", "", 22),
    COAL_MINED (14, "Coal, Mined", SkuUsageClassification.FUEL, "", "", 176),
    COPPER (15, "Copper", SkuUsageClassification.RAW_MATERIAL, "", "", 6019),
    ...
    GOLD_BAR (21, "Gold, bar", SkuUsageClassification.RAW_MATERIAL, "", "", 33),
    ...
    HARD_STEEL (26, "Hard Steel", SkuUsageClassification.ORE, "kg", "This technique involves melting wrought iron with carbon in small crucibles, creating steel with unique properties that allowes for strong, flexible, and sharp-edged weapons. ", 2318),
    ...
    MILD_STEEL (30, "Mild Steel", SkuUsageClassification.RAW_MATERIAL, "", "Mild steel is a type of carbon steel with a low amount of carbon. It is also known as low carbon steel. ", 2318),
    ...
    SCRAP_BRONZE_METAL (42, "Scrap Bronze metal", SkuUsageClassification.OTHER, "kg", "", 33),
    SCRAP_COPPER_METAL (43, "Scrap copper metal", SkuUsageClassification.OTHER, "kg", "", 33),
    SOYA (44, "Soya", SkuUsageClassification.FOOD, "", "", 33),
    SCRAP_IRON_METAL (45, "Scrap iron metal", SkuUsageClassification.OTHER, "kg", "", 33),
    SCRAP_STEEL_METAL (46, "Scrap Steel metal", SkuUsageClassification.OTHER, "kg", "", 33),
    SILVER_ORE (47, "Silver Ore", SkuUsageClassification.ORE, "", "", 88),
    SILVER_BAR (48, "Silver, bar", SkuUsageClassification.RAW_MATERIAL, "", "", 33),
    ...
    STAINLESS_STEEL (50, "Stainless Steel", SkuUsageClassification.OTHER, "kg", "Stainless Steel is alloyed using chromium.", 33),
    WHEAT (51, "Wheat", SkuUsageClassification.FOOD, "", "", 33),
    WROUGHT_IRON (52, "Wrought Iron", SkuUsageClassification.RAW_MATERIAL, "kg", "Wrought Iron is relatively soft but malleable. It contains traces of slag, making it less pure than modern iron but still highly functional for making a variety of tools and weapons.", 1743),
    STEEL_TOOLS (53, "Steel tools", SkuUsageClassification.TOOLS, "kg", "", 33),
    STONE_TOOLS (54, "Stone tools", SkuUsageClassification.TOOLS, "kg", "", 880),
    TIN (55, "Tin", SkuUsageClassification.RAW_MATERIAL, "", "", 33),
